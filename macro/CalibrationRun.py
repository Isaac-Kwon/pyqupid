...
class CalibrationSingleExp(ClusterSimulation):#ne_alpha  : 540,272.98 = for 1.93958MeV
...
def CalibrationRun(ntime = 10):
    df = DataFrame()
    print("===================")
    detector = Digitizer(-10, 10, 20, -10, 10, 20, threshold=250)
    exp = CalibrationSingleExp(detector=detector, sigrange=(540273*0.5, 540273*1.5), devrange=(0.75, 0.91))
